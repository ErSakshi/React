...
const Hoome = () => {
    ...
    const goBackToHome = () => {
      setIsCartTrue(false);  // Set to false to go back to home page
    };
  return (
    <div style={{border:"2px solid black" ,height:"100vh"}}>
      <header style={{
        ...
        <div style={{width:"40%"}}><h1>Logo</h1></div>
        <div style={{width:"40%"}}>
          <h2 style={{marginRight:"20vw"}}><a href="#" style={{marginLeft:"30vw" ,color:"black",textDecoration:"none"}}
          onClick={()=>{setIsCartTrue(true)
      ...
      {isCartTrue?(
        <Cart data={cartData} goBack={goBackToHome}/>
      ):(
        ...
        {products.map((ele,idx)=>(
          ...
          borderStyle:"double"
           ...
           <img src={ele.images} alt=""  style={{height:"150px"}}/>
           <h2>{ele.title}</h2>
